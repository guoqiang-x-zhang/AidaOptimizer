...
**_NOTE:_** For instance, the adaptive stepsizes in Adam are <img src="https://render.githubusercontent.com/render/math?math=1/(\sqrt{v_t}%2B\epsilon)" width="70"/>, where <img src="https://render.githubusercontent.com/render/math?math=v_t"> is the exponential moving average (EMA) of the squared gradient over iterations.
